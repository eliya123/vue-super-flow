...
export default {
  ...
  created() {
    ...
    const linkList = [
      {
        id: "linkBnpexZGgvMzeR281",
        startId: "nodej6nMfZE760CPcbkP",
        endId: "nodeP8CUhniSzu17done",
        startAt: [120, 20],
        endAt: [0, 20],
        meta: null,
      },
      {
        id: "link41XSpcNyo2m0tcGc",
        startId: "nodeP8CUhniSzu17done",
        endId: "node5uTi28hzDkcVttv6",
        startAt: [120, 20],
        endAt: [0, 20],
        meta: null,
      },
      {
        id: "linkJgCgKbVfLXkCrbr1",
        startId: "nodej6nMfZE760CPcbkP",
        endId: "nodeYmdWPlDfKUyb9FlF",
        startAt: [60, 40],
        endAt: [0, 20],
        meta: null,
      },
